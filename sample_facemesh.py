...
def draw_landmarks(image, landmarks):
    ...
    if len(landmark_point) > 0:
        ...
        # 左眉毛(55：内側、46：外側)
        cv.line(image, landmark_point[55], landmark_point[65], (0, 255, 255), 2)
        cv.line(image, landmark_point[65], landmark_point[52], (0, 255, 255), 2)
        cv.line(image, landmark_point[52], landmark_point[53], (0, 255, 255), 2)
        cv.line(image, landmark_point[53], landmark_point[46], (0, 255, 255), 2)
